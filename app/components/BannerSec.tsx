...
const Banner: React.FC = () => {
    return (
        <section className='relative bg-accent-light' style={{ backgroundImage: "linear-gradient(to bottom right, #FDE9E5 , #F9F9F9)" }}>
            ...
            <Wrapper className='px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 relative z-10'>
                            ...
                            <div className="relative w-64 sm:w-80 lg:w-96 mx-auto transform hover:scale-105 transition-transform duration-500">
                                ...
                                <div className="relative bg-dark rounded-[2.5rem] p-3 shadow-2xl">
                                    <div className="bg-white rounded-4xl overflow-hidden">
                                        <img src="/images/bannersec-women.avif" alt="A fashionable African woman in a vibrant dress checks her phone outdoors.  The urban setting is blurred, focusing attention on her." className="w-full h-auto object-cover" />
                                    </div>
                                </div>
                            </div>
